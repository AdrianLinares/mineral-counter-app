...
export const TEXTURE_DATABASE: Record<string, TextureTerm[]> = {
  texturas_igneas: [
    ...
    { term: "Panidiomorfa", description: "Todos los cristales con caras propias" },
    { term: "Alotriomorfa", description: "Cristales sin caras propias" },
    { term: "Hipidiomorfa", description: "Mezcla de cristales con y sin caras" },
    ...
    { term: "Poiquilítica", description: "Cristal grande con inclusiones" },
    ...
    { term: "Amigdalar", description: "Vesículas rellenas de minerales" },
